...
function Message() {
	return (<div className="message anim" /* style="--delay: .1s" */>
				...
				<div className="video-stream">
					...
					<div className="video-detail">
						<div className="video-content">
							...
							<div className="video-p-subtitle anim" /* style="--delay: .3s" */>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus illum tempora consequuntur. Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis earum velit accusantium maiores qui sit quas, laborum voluptatibus
